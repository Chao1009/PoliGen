...
revert*; and **row 27** (§B28), the sibling repository's published
...
| 13 | License | **author decision — row 24** (carried forward; E2 built on it) | **GPL-3.0-or-later**, stamped as `SPDX-License-Identifier` on **103 of 103** files the gate checks; `AUTHORS` and `CITATION.cff` each carry one literal **placeholder** where the name goes — that is decision row 13, unanswered | §12–13; `AUTHOR_DECISIONS.md` §§B21, B22 |
