...
| `[eSTARlight]` | M. Lomnitz, S. R. Klein, Phys. Rev. C **99** (2019) 015203 | check for arXiv | The coherent-baseline generator paper |
...
| Rodning & Knutson, PRC **41** (1990) 898 (+ PRL **57** (1986) 2248) | No arXiv (1990) | η_d = 0.0256(4), the deuteron analogue of the George–Knutson technique | **Not in corpus** |
