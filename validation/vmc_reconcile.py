...
def write_markdown(path, kmax, m6_models, m7_models, m6, m7, kappa6, kappa7,
    ...
    n00, n22, n33 = extra["n00"], extra["n22"], extra["n33"]
    n00g, n22g = n00 * HBARC, n22 * HBARC
...
| region | sign(ψ₂/ψ₀) |
|---|---|
| k < {n00:.3f} fm⁻¹ = {n00g:.3f} GeV (below the **S** node) | **−1** |
| {n00:.3f} < k < {n22:.3f} fm⁻¹ (between the S and D nodes) | **+1** |
| k > {n22:.3f} fm⁻¹ = {n22g:.3f} GeV | −1 |
...
node positions it finds ({n00:.3f} and {n22:.3f} fm⁻¹ for ⁶Li, {n33:.3f} fm⁻¹ for
